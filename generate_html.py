...
const METRIC_HELP={
  ...
  mt_food_safe:'食品安全负反馈率：与同二级城市、同品类、同客单价区间的商家进行排名比较计分。每个名次区间依次递减0.1分，如第一个区间5分，第二个区间4.9分，依次递减',
  ...
  mt_service_fb:'服务负反馈率：与同二级城市、同品类、同客单价区间的商家进行排名比较计分，每个名次区间依次递减0.1分，如第一个区间5分，第二个区间4.9分，依次递减',
