...
const METRIC_HELP={
  ...
  mt_repeat_score:'复购率指标得分：与同二级城市、同品类、同客单价区间的商家进行排名比较计分。每个名次区间依次递减0.1分，如第一个区间5分，第二个区间4.9分，依次递减',
  ...
  mt_reply_score:'消息回复率得分：与同二级城市、同品类、同客单价区间的商家进行排名比较计分。每个名次区间依次递减0.1分，如第一个区间5分，第二个区间4.9分，依次递减',
